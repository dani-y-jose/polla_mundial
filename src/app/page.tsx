      ...
      <main className="flex-1 flex flex-col items-center justify-center relative overflow-hidden px-6">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-gray-200 to-gray-500">
            Pronostica. Compite. <br/> Gana la Gloria.
          </h1>
          
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            La plataforma definitiva para seguir pronósticos de la Copa Mundial con tus amigos y colegas. 
            Experimenta tablas de posiciones en tiempo real y puntuaciones dinámicas.
          </p>
