          ...
          {activeTab === "profile" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                {/* Join Group Card */}
                <div className="p-5 bg-white/5 border border-white/10 rounded-2xl space-y-3">
                  <h3 className="font-bold text-sm text-purple-400 uppercase tracking-wider">Unirse a un Grupo</h3>
                ...
                {/* Create Group Card */}
                <div className="p-5 bg-white/5 border border-white/10 rounded-2xl space-y-3">
                  <h3 className="font-bold text-sm text-emerald-400 uppercase tracking-wider">Crear un Grupo</h3>
                ...
                {groups.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {groups.map(g => (
                      <div 
                        key={g.id}
                        className="p-4 bg-black/40 border border-white/5 rounded-xl flex justify-between items-center text-xs"
                      >
                        <div>
